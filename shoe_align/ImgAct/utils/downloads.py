...
from ImgAct.utils import ASSETS_URL, LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def attempt_download_asset(
    ...
    **kwargs,
    ...
    """
    from ImgAct.utils import SETTINGS  # scoped for circular import

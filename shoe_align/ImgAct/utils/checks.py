...
def check_file(file, suffix="", download=True, download_dir=".", hard=True):
    ...
    if (
        ...
        from ImgAct.utils.callbacks.platform import resolve_platform_uri
...
def check_yolo(verbose=True, device=""):
    ...
    from ImgAct.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from ImgAct.utils import ENVIRONMENT  # scope to avoid circular import
    from ImgAct.utils.torch_utils import get_cpu_info, get_gpu_info
...
def is_intel():
    ...
    """
    from ImgAct.utils.torch_utils import get_cpu_info

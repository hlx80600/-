...
from ImgAct.utils import ENVIRONMENT, GIT, LOGGER, PYTHON_VERSION, RANK, SETTINGS, TESTS_RUNNING, Retry, colorstr
...
try:
    ...
    from ImgAct.utils.logger import ConsoleLogger, SystemLogger
    from ImgAct.utils.torch_utils import model_info_for_loggers
...
def _upload_model(model_path, project, name, progress=False, retry=1, model_id=None):
    ...
    from ImgAct.utils.uploads import safe_upload

...
from ImgAct.utils.cpu import CPUInfo
...
def get_cpu_info():
    ...
    from ImgAct.utils import PERSISTENT_CACHE  # avoid circular import error
...
def select_device(device="", newline=False, verbose=True):
    ...
    # Auto-select GPUs
    if "-1" in device:
        from ImgAct.utils.autodevice import GPUInfo
...
def model_info_for_loggers(trainer):
    ...
    if trainer.args.profile:  # profile ONNX and TensorRT times
        from ImgAct.utils.benchmarks import ProfileModels

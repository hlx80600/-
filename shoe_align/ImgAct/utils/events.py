...
from ImgAct import SETTINGS, __version__
from ImgAct.utils import ARGV, ENVIRONMENT, GIT, IS_PIP_PACKAGE, ONLINE, PYTHON_VERSION, RANK, TESTS_RUNNING
from ImgAct.utils.downloads import GITHUB_ASSETS_NAMES

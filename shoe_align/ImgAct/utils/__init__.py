...
from ImgAct.utils.git import GitRepo
from ImgAct.utils.patches import imread, imshow, imwrite, torch_save  # for patches
from ImgAct.utils.tqdm import TQDM  # noqa
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from ImgAct.utils.torch_utils import torch_distributed_zero_first

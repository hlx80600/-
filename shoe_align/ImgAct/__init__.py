...
from ImgAct.utils import ASSETS, SETTINGS
from ImgAct.utils.checks import check_yolo as checks
from ImgAct.utils.downloads import download
...
if TYPE_CHECKING:
    ...
    from ImgAct.models import YOLO, YOLOWorld, YOLOE, NAS, SAM, FastSAM, RTDETR  # noqa

...
from ImgAct.cfg import TASK2DATA, get_cfg, get_save_dir
from ImgAct.engine.results import Results
from ImgAct.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        # HUB is disabled in this fork; only local files and Triton endpoints are supported here.
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        # HUB is disabled in this fork; always treat models as local files or Triton endpoints.
        return False
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ImgAct.trackers import register_tracker
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        """
        self._check_is_pytorch_model()
        from ImgAct.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ImgAct.utils.tuner import run_ray_tune

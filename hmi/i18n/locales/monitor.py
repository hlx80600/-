...
MONITOR_BY_LANG: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "monitor.slot.title_locked": "当前槽号（自动运行中锁定）",
        "monitor.slot.title_edit": "当前槽号（可改槽号、顺序）",
        "monitor.mem.title_locked": "记忆 Mem1～10（自动运行中锁定）",
        "monitor.mem.title_edit": "记忆 Mem1～10（暂停/停止后可勾选）",
        ...
        "monitor.grip.ang1_open": "上料张开角度",
        "monitor.grip.ang1_close": "上料夹紧角度",
        "monitor.grip.ang2_open": "下料张开角度",
        "monitor.grip.ang2_close": "下料夹紧角度",
        "monitor.grip.save_spd": "保存夹爪速度/角度到 yaml",
        ...
        "monitor.mock.belt_status": "光电 DI[{id}]: {state} | 中转 {filt}",
        "monitor.mock.belt_on": "模拟光电感应到位",
        "monitor.mock.belt_on_tip": "置光电 DI=True；滤波后中转有料才触发 Station1（需 Mem[1]=False）",
        ...
        "monitor.mock.belt_filt_on": "有料",
        "monitor.mock.belt_filt_off": "无料",
    ...
    "en-US": {
        ...
        "monitor.slot.title_locked": "Slots (locked while running)",
        "monitor.slot.title_edit": "Slots (editable when stopped/paused)",
        "monitor.mem.title_locked": "Memory Mem1–10 (locked while running)",
        "monitor.mem.title_edit": "Memory Mem1–10 (editable when stopped/paused)",
        ...
        "monitor.grip.ang1_open": "Load open angle",
        "monitor.grip.ang1_close": "Load close angle",
        "monitor.grip.ang2_open": "Unload open angle",
        "monitor.grip.ang2_close": "Unload close angle",
        "monitor.grip.save_spd": "Save gripper speed/angle to yaml",
        ...
        "monitor.mock.belt_status": "Photo DI[{id}]: {state} | filtered {filt}",
        "monitor.mock.belt_on": "Simulate shoe present",
        "monitor.mock.belt_on_tip": "Set photo DI=True; Station1 waits for filtered present (needs Mem[1]=False)",
        ...
        "monitor.mock.belt_filt_on": "present",
        "monitor.mock.belt_filt_off": "empty",
        ...
        "monitor.tab.links": "Links / Stations",
        "monitor.tab.speed": "Speed / Blend",
        "monitor.tab.manual": "Manual I/O",
        "monitor.tab.dry": "Dry-run shortcuts",
